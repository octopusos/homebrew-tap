class Octoryn < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/octopusos/octoryn-llm/releases/download/cli-v0.1.0/octoryn-darwin-arm64"
      sha256 "55cf92ad6bb21a3d195328f2de86af330e9b0996ab062186f6dbcfe6822e1cb5"
    end
    on_intel do
      url "https://github.com/octopusos/octoryn-llm/releases/download/cli-v0.1.0/octoryn-darwin-x64"
  ...
  on_linux do
    on_arm do
      url "https://github.com/octopusos/octoryn-llm/releases/download/cli-v0.1.0/octoryn-linux-arm64"
      sha256 "b0e4f6dd20b4790cf2bd6768a63681b2aee18ba1e21354fd4711f506db8ee258"
    end
    on_intel do
      url "https://github.com/octopusos/octoryn-llm/releases/download/cli-v0.1.0/octoryn-linux-x64"
